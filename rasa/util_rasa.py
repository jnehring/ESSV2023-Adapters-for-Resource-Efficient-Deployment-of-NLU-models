...
def read_args():
    ...
    parser.add_argument("--experiment", type=str, default="single_experiment", choices=["single_experiment", "rasa_experiment", "full_experiment", "search_hyperparameter", "duration_experiment"])
